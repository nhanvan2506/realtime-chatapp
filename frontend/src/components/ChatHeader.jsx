...
function ChatHeader() {
    const { selectedUser, setSelectedUser, chatThemes, setChatTheme } = useChatStore();
        ...
        <div className='p-4 bg-slate-800/50 border-b border-slate-700/50'>
            <div className='flex items-center justify-between gap-2'>
                ...
                <div className='flex items-center gap-1 shrink-0'>
                    ...
                    <button className='p-2 rounded-lg text-slate-400 hover:text-rose-400 hover:bg-white/10 transition-colors' onClick={() => setSelectedUser(null)}>
